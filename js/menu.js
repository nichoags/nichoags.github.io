...
function togglePassword(inputId, iconId) {
  ...
  if (input.type === 'password') {
      ...
      icon.classList.remove('bx-hide'); // Menghapus kelas hide
      icon.classList.add('bx-show'); // Menambahkan kelas show
  } else {
      input.type = 'password'; // Ubah tipe input kembali menjadi password
      icon.classList.remove('bx-show'); // Menghapus kelas show
      icon.classList.add('bx-hide'); // Menambahkan kelas hide
  }
}
