...
// Query untuk menghitung total transaksi penyimpanan berdasarkan id_anggota
$query_simpanan = "SELECT SUM(nominal) AS total_simpanan FROM simpanan WHERE id_anggota = '$id_anggota';";
...
if ($result_simpanan) {
    ...
    $total_simpanan = $row_simpanan['total_simpanan'] ?: 0; // Default ke 0 jika null
} else {
    echo "Error: " . $connection->error; // Tambahkan pesan kesalahan
}

// Query untuk menghitung total transaksi pinjaman berdasarkan id_anggota
$query_pinjaman = "SELECT SUM(nominal) AS total_pinjaman FROM pinjaman WHERE id_anggota = '$id_anggota';";
...
if ($result_pinjaman) {
    ...
    $total_pinjaman = $row_pinjaman['total_pinjaman'] ?: 0; // Default ke 0 jika null
} else {
    echo "Error: " . $connection->error; // Tambahkan pesan kesalahan
}

// Format total transaksi menjadi bentuk uang
$total_simpanan_formatted = "Rp " . number_format($total_simpanan, 0, ',', '.');
$total_pinjaman_formatted = "Rp " . number_format($total_pinjaman, 0, ',', '.');
                ...
                <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                    <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                        ...
                        <div class="mt-sm-auto">
                            ...
                            <h3 class="mb-0"><?= $total_simpanan_formatted; ?></h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between flex-sm-row flex-column gap-3">
                    <div class="d-flex flex-sm-column flex-row align-items-start justify-content-between">
                        ...
                        <div class="mt-sm-auto">
                            <small class="text-nowrap fw-semibold">Jumlah Total:</small>
                            <h3 class="mb-0"><?= $total_pinjaman_formatted; ?></h3>
                        </div>
                    </div>
                </div>
            </div>
